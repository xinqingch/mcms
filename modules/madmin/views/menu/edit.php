                    ...
                    <?php $form = ActiveForm::begin([
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <?= Html::dropDownList('Sysmenu[fatherId]',$model['fatherId'],$allmenu,['class'=>'form-control','empty'=>'一级菜单']);?>
                            </div>
                            <div class="form-group">
                                <label for="index_keyword">菜单类型</label>
                                <?= Html::dropDownList('Sysmenu[type]',$model['type'],['navigate'=>'一级','group'=>'目录','menu'=>'菜单','action'=>'动作'],['class'=>'form-control','empty'=>'一级菜单']);?>
                            </div>
                            <div class="form-group">
