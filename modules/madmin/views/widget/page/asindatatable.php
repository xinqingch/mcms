            ...
            aoColumns:[
                //复选框（通过render渲染复选框）
                {
                    ...
                    render: function (data, type, full, meta) {
                        var node = '';
                        node = '<input class="checkchild" name="ids"  value=\"'+full.asinid+'\" type="checkbox"/>';
                        return node;
                    }
                },
                {
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        // 使用 JavaScript 的 Date 对象将 Unix 时间戳转换为日期
                        var date = new Date(data * 1000); // 注意：如果时间戳是以秒为单位的，需要乘以 1000
